...
export const metadata: Metadata = {
  title: "جائزة مايدة محي الدين ناظر للابتكار 4 | هاكاثون الابتكار",
  description:
...
const structuredData = {
  ...
  "@type": "Event",
  name: "جائزة مايدة محي الدين ناظر للابتكار",
  description:
    "تحدي يجمع طلبة الجامعات لاستكشاف وتوظيف الابتكارات الجامعية، توفر جائزة مايـدة محي الديـــن ناظـــر للابتكــــار هاكاثون الابتكار فرصة للعمل ضمن فرق تنافسية على تطوير حلول مبتكرة تسهم في تعزيز الاستدامة وجودة الحيـاة",
  organizer: {
    "@type": "Organization",

...
export default function SiteFooter({ standalone = false }: { standalone?: boolean }) {
  const footer = (
    <footer className="dhl-footer">
      ...
      <a className="dhl-f-phone" href="tel:+966557552166">+966 557552166</a>
      <svg className="dhl-f-wa-icon" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <a className="dhl-f-wa" href="https://wa.me/966557552166" target="_blank" rel="noopener noreferrer" aria-label="واتساب +966 557552166">+966 557552166</a>
    </footer>
  );
